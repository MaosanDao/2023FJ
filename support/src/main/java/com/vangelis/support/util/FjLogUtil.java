 ...
 * @author Wangpei
 */
public class FjLogUtil {

    //单例
    private static FjLogUtil hbLogUtil;
    //打印调试开关
    ...
    //单例模式初始化
    public static FjLogUtil getInstance() {
        if (hbLogUtil == null) {
            hbLogUtil = new FjLogUtil();
        }
        return hbLogUtil;
    }
     ...
     * @param isOpen 开关
     */
    public void logEnable(boolean isOpen){
        IS_DEBUG = isOpen;
    }
